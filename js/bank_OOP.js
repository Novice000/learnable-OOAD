"use strict";
class Bank {
    static validBankNames = ["Access Bank", "Zenith Bank", "GT Bank"];
    bankName;
    fullName;
    accountNumber;
    pin;
    balance;
    constructor({ bankName, fullName, pin }) {
    ...
    static generateAccountNumber(bankName) {
